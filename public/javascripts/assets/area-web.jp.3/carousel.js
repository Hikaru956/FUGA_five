$(function()
{
    ...
    new function() {
        ...
        var ul       = $('#carousel_ul1');
        var length   = ul.children('li').length;
        ul.children('li').first().clone().appendTo('#carousel_ul1');
        ...
        /* イベント：次へボタンクリック */
        $('#carousel_next1').click(function(){
            next();
            return false;
        });
        /* イベント：次へボタンタップ */
        $('#carousel_next1').on('tap', function(){
            next();
            return false;
        });
        /* イベント：前へボタンクリック */
        $('#carousel_prev1').click(function(){
            prev();
            return false;
        });
        /* イベント：前へボタンタップ */
        $('#carousel_prev1').on('tap', function(){
            prev();
            return false;
        });
        /* イベント：左スワイプ */
    ...
    new function() {
        ...
        var ul       = $('#carousel_ul2');
        var length   = ul.children('li').length;
        ul.children('li').first().clone().appendTo('#carousel_ul2');
        ...
        /* イベント：次へボタンタップ */
        $('#carousel_next2').on('tap', function(){
            next();
            return false;
        });
        /* イベント：前へボタンクリック */
        ...
        /* イベント：前へボタンタップ */
        $('#carousel_prev2').on('tap', function(){
            prev();
            return false;
        });
        /* イベント：左スワイプ */
